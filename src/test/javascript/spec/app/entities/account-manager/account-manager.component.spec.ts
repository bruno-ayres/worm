...
import { AccountManagerComponent } from 'app/entities/account-manager/account-manager.component';
...
describe('Component Tests', () => {
    describe('AccountManager Management Component', () => {
        let comp: AccountManagerComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AccountManagerComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.accountManagers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
