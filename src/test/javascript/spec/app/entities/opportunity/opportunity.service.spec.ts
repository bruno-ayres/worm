...
import { IOpportunity, Opportunity, OpportunityStatus } from 'app/shared/model/opportunity.model';
...
describe('Service Tests', () => {
    describe('Opportunity Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Opportunity(0, 'AAAAAAA', OpportunityStatus.RESERVED, 0, 0, currentDate);
        });
